...
## [Version 3.33.5] - 2026-01-20

### Changed
- All pin mappings and GPIO names now use the *_PIN convention and are strictly synchronized between code and documentation (see board_config.h and PIN_MAPPING.md)
- Documentation updated to reflect new naming and mapping
...
### Documentation
- Updated README/README_FR, pin mapping guides, feature matrix, usage, build guides; bumped `PROJECT_VERSION` to `3.19.0` in `platformio.ini`.
