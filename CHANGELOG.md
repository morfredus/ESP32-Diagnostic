...
- **MQTT Handler**: New core implementation in `include/mqtt_handler.h`
  ...
  - State machine: DISCONNECTED → CONNECTING → CONNECTED → DISABLED
...
- ✅ **Fully backward-compatible** - MQTT disabled by default
- ✅ **No breaking changes** - All existing features unaffected
- ✅ **No hardware changes** - Works with existing wiring
