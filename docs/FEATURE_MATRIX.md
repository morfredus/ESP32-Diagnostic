...
> **Important:** Version 3.9.0 (PlatformIO) **does not support Bluetooth/BLE** functionality. For BLE diagnostics, use the archived [ESP32-Diagnostic](https://github.com/morfredus/ESP32-Diagnostic) Arduino IDE version.
