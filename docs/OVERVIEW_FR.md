# ESP32 Diagnostic Suite – Vue d'ensemble (v3.33.0)
...
## Mission
## Dernière Mise à Jour : v3.33.0

**Nouveautés v3.33.0 :** Barre de progression TFT fluide, NeoPixel violet, logique BOOT robuste, et sélection dynamique du contrôleur TFT (ILI9341 ou ST7789). Voir [RELEASE_NOTES_3.33.0_FR.md](RELEASE_NOTES_3.33.0_FR.md) pour les détails.
