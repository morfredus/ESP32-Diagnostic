...
- Tag releases with annotated Git tags (e.g., `v3.9.0`) to ensure traceability between code and deployed firmware.
...
## Incident response
- If tampering is suspected, perform a factory reset: erase flash via `esptool.py erase_flash`, then reflash 3.8.0.
