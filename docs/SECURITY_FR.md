...
- Taguer les releases avec des tags Git annotés (ex. `v3.9.0`) pour assurer la traçabilité code ↔ firmware.
...
## Réponse à incident
- En cas de suspicion, effectuer un factory reset : `esptool.py erase_flash`, puis reflasher 3.8.0.
