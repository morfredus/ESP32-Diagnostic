...
// ATTENTION : Ce fichier est la référence ABSOLUE pour le mapping des pins !
// Toute utilisation de pins dans le code ou la documentation doit utiliser EXCLUSIVEMENT les macros définies ici.
